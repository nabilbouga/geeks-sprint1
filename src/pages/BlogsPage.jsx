      ...
      <div className="container mx-auto px-4 py-12 pt-16">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="border-2 border-dashed border-indigo-200 bg-indigo-50 rounded-lg p-4 text-center hover:bg-indigo-100 transition-colors cursor-pointer flex flex-col justify-center items-center h-full">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mx-auto text-indigo-500 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              <p className="text-indigo-700 text-sm font-medium">Upload image</p>
              <p className="text-indigo-500 text-xs">Max 5MB</p>
            </div>
          </div>
